...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            "paper30__seed1442__standard_pca15_patch25",
            True,
        ),
        (
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            "lda",
            "patch",
            "fair24_6_70__seed1442__standard_lda8_patch25",
            True,
        ),
        (
            "fair24_6_70",
            "pca",
            "pixel",
            "fair24_6_70__seed1442__standard_pca15_pixel",
            False,
        ),
        (
            "fair24_6_70",
            "lda",
            "pixel",
            "fair24_6_70__seed1442__standard_lda8_pixel",
            False,
        ),
        (
            "fair24_6_70",
            "none",
            "pixel",
            "fair24_6_70__seed1442__standard_none_pixel",
            False,
        ),
        (
            "paper30",
